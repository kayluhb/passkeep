  ...
  def clippy(text, id, bgcolor='#F5F5F5')
    ...
    html = <<-EOF
      <span class="clippy">
        ...
        <embed src="/assets/clippy.swf" width="110" height="14" name="clippy-#{id}" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" FlashVars="text=#{text}" bgcolor="#{bgcolor}" />
        </object>
      </span>
    EOF
    html.html_safe
